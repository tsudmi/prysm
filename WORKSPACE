...
git_repository(
    ...
    commit = "21df5bdaf732300fad48519ef9ba4eca5c20a7f8",
...
proto_library(
  ...
  visibility = ["//visibility:public"],
    ...
    sha256 = "8f8372bf546ba1b72301a2366e3c91cd58570f463d4f5044479760de105f866a",
    strip_prefix = "prysm-testnet-site-165dc270d8b78421d19a692e030a84cd3da64e19",
    url = "https://github.com/prestonvanloon/prysm-testnet-site/archive/165dc270d8b78421d19a692e030a84cd3da64e19.tar.gz",
)""",
...
http_archive(
    ...
    sha256 = "43ded3945798f607a6649178dbae51151b96fb23098296fc5897c7594091341e",
    strip_prefix = "repo-infra-b65e86c87583efb6e49d0bba62676bdd6fa7f5c6",
    url = "https://github.com/kubernetes/repo-infra/archive/b65e86c87583efb6e49d0bba62676bdd6fa7f5c6.tar.gz",
)
...
filegroup(
    ...
    """,
    sha256 = "9ff0a4bae7ae23863d906c6a0186b7760ec7f8504b4645f6b9468b2a61b0a6de",
    url = "https://github.com/ethereum/eth2.0-spec-tests/releases/download/v0.10.0/general.tar.gz",
)
    """,
...
filegroup(
    ...
    """,
    sha256 = "2924d203beb0515a4a1a6fefdd4a75d904ce06c768788720c6bde34d02a87c1d",
    url = "https://github.com/ethereum/eth2.0-spec-tests/releases/download/v0.10.0/minimal.tar.gz",
)
    """,
...
git_repository(
    ...
    commit = "f4b6e4a561480fa6727e9d9a4537c404c23ff5f6",
...
go_repository(
    ...
    commit = "629b6ff9b3aafafba54ab96663903fde9544f037",  # v0.8.0
...
go_repository(
    ...
    build_file_proto_mode = "disable_global",
    commit = "79c2a76c473a20cdc4ce59cae4b72529b5d9d16b",  # v0.17.1
...
go_repository(
    name = "io_k8s_api",
    build_file_proto_mode = "disable_global",
    commit = "7643814f1c97f24ccfb38c2b85a7bb3c7f494346",  # v0.17.1
...
go_repository(
    ...
    commit = "b4cdc8d6eb508c4e74df26094d1adb678c87f818",  # v0.51.0
